...
<%@ include file="../common/toastUi.jsp"%>
	...
	<section class="mt-8">
		<div class="container mx-auto">
			<form action="doModify" onsubmit="submitForm(this); return false;" method="GET">
				<input type="hidden" name="id" value="${article.id }"/>
				<input type="hidden" name="body" value="${article.getForPrintBody() }"/>
	...
	<script>
		...
		$('.toast-ui-editor').html($('input[name=body]').attr('value'));
	</script>
